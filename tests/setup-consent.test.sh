...
has 'setup asks keep or remove through the question panel' \
...
lacks 'the launch rule is the only permission rule setup names — the push rule is gone with the remote question' \
  'Only if the user took a remote above|plugin-push'
